...
Compare what different routing policies would do over your historical workload. Runs as a what-if over your current lane configuration and observed evidence by calling the MCP tool `mcp__plugin_tokenmaxed_tokenmaxed__router_backtest`.
