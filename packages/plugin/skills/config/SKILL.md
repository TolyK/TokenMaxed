...
Usage: `/tokenmaxed:config` · `/tokenmaxed:config <key>` · `/tokenmaxed:config <key> <value|clear>`
...
2. Call the MCP tool `mcp__plugin_tokenmaxed_tokenmaxed__router_config` with
