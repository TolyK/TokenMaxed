#!/usr/bin/env node
// Generated by packages/hermes-plugin/build.mjs — DO NOT EDIT. TokenMaxed pre_tool_call gate (Hermes).
...
// ../mcp/src/hook-hermes-pretoolcall.ts
var import_node_fs3 = require("node:fs");

// ../mcp/src/hermes-hooks.ts
var HERMES_DELEGATE_TOOL = "mcp_tokenmaxed_router_delegate";
function isHermesDelegateCall(payload) {
...
var HOME_TM = (0, import_node_path.join)((0, import_node_os.homedir)(), ".tokenmaxed");
function homeFile(name) {
  return (0, import_node_path.join)(HOME_TM, name);
}
...
function loadSettings(env) {
  ...
  if (!(0, import_node_fs.existsSync)(path)) return { values: {}, present: false, invalid: [] };
  let parsed;
  try {
...
function delegateDenyReason(env) {
  try {
    ...
    const store = {
      read: () => {
        if (!statePath || !(0, import_node_fs2.existsSync)(statePath)) return {};
        try {
          return JSON.parse((0, import_node_fs2.readFileSync)(statePath, "utf8"));
        } catch {
          return {};
        }
      },
