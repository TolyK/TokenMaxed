#!/usr/bin/env node
// Generated by packages/codex-plugin/build.mjs — DO NOT EDIT. TokenMaxed Stop review loop (Codex CLI, strict schema).
...
function blockPayload(dialect, reason) {
  return {
    decision: "block",
    reason,
...
async function stopMain(dialect) {
...
// ../mcp/src/hook-codex-stop.ts
stopMain("codex").catch(() => {
