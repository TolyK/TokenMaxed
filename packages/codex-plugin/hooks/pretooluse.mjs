#!/usr/bin/env node
// Generated by packages/codex-plugin/build.mjs — DO NOT EDIT. TokenMaxed PreToolUse gate (Codex CLI).
...
// ../mcp/src/config.ts
var HOME_TM = join(homedir(), ".tokenmaxed");
...
function main() {
  try {
    readFileSync2(0, "utf8");
  } catch {
  }
  const env = effectiveEnv(process.env);
  const statePath = env.TOKENMAXED_STATE ?? (env.CLAUDE_PLUGIN_DATA ? join2(env.CLAUDE_PLUGIN_DATA, "state.json") : "");
