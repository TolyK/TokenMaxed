...
Take the user's argument (everything after `/tokenmaxed_prefer`, trimmed) as the lane id.
...
ranking, and `/tokenmaxed_why` (or `router_preview`) will show what was actually picked.
